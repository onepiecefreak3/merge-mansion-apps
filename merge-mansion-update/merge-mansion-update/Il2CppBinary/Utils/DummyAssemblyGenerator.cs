...
namespace merge_mansion_update.Il2CppBinary.Utils
{
    ...
    {
        private const string DummyDllPath = "Il2CppBinary.Il2CppDummyDll.dll";
        ...
        public DummyAssemblyGenerator(Il2CppExecutor il2CppExecutor)
        {
            ...
            //Il2CppDummyDll
            var dummyStream = GetType().Assembly.GetManifestResourceStream(DummyDllPath);
            var il2CppDummyDll = AssemblyDefinition.ReadAssembly(dummyStream);
