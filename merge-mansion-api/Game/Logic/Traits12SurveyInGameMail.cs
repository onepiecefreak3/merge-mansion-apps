...
namespace Game.Logic
{
    ...
    public class Traits12SurveyInGameMail : MergeMansionMailContents, IBroadcastMailMessage
    {
        ...
        private Traits12SurveyInGameMail()
        {
        }

        public Traits12SurveyInGameMail(string topic, string content, string excerptTopic, string excerptContent, string url, int broadcastId, LanguageId language, MetaTime endDate, List<PlayerReward> startingRewards, List<PlayerReward> completingRewards, MailDeliveryFilters deliveryFilters)
        {
        }
    }
}