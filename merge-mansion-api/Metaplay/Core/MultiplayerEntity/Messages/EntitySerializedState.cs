...
namespace Metaplay.Metaplay.Core.MultiplayerEntity.Messages
{
    public struct EntitySerializedState
    {
        ...
        public EntitySerializedState(MetaSerialized<IMultiplayerModel> publicState,
            MetaSerialized<MultiplayerMemberPrivateStateBase> memberPrivateState, int currentOperation,
            int logicVersion, ContentHash sharedGameConfigVersion, ContentHash sharedConfigPatchesVersion,
