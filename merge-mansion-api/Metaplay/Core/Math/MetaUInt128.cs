...
namespace Metaplay.Core.Math
{
    public struct MetaUInt128 : IEquatable<MetaUInt128>, IComparable<MetaUInt128>, IComparable
    {
        ...
        public static MetaUInt128 operator <<(MetaUInt128 a, int sh)
        {
            ...
            return sh < 0x40 ?
                new MetaUInt128(a.High << sh | (a.Low >> (0x40 - sh)), a.Low << sh) :
                new MetaUInt128(a.Low << (sh - 0x40), 0);
        }
        ...
        public static MetaUInt128 operator >>(MetaUInt128 a, int sh)
        {
            ...
            return sh < 0x40 ?
                new MetaUInt128(a.High >> sh, a.Low >> sh | (a.High << (0x40 - sh))) :
                new MetaUInt128(0, a.High >> (sh - 0x40));
        }
