...
{
    [AnalyticsEvent(1199, "<Failed to Deserialize Event!>", 1, "This is a substitute event that is shown if the original serialized event could not be deserialized. This can happen if even data format is changed in an incompatible way.", true, false, false)]
