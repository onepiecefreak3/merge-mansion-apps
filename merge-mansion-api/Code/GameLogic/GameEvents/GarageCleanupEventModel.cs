...
namespace Code.GameLogic.GameEvents
{
    ...
    public class GarageCleanupEventModel : MetaActivableState<GarageCleanupEventId, GarageCleanupEventInfo>, IEventGroupModel<GarageCleanupEventInfo>, IGroupIdGetter
    {
